...
function keyPressed() {
  ...
  if (key === "t" || key === "T") {
    ...
    // Falas do Gerald
    if (numArvoresPlantadas % 15 === 0) {
      if (numArvoresPlantadas === 25) {
        geraldSpeech = "Boa! Você plantou 25 árvores!";
      } else if (numArvoresPlantadas === 50) {
        geraldSpeech = "Ótimo! 50 árvores plantadas!";
      } else if (numArvoresPlantadas === 75) {
        geraldSpeech = "Estamos indo bem! 75 árvores!";
      } else if (numArvoresPlantadas === 100) {
        geraldSpeech = "Incrível! Você plantou 100 árvores!";
      } else if (numArvoresPlantadas === 125) {
        geraldSpeech = "Você é um mestre das árvores! 125 plantadas!";
      } else {
